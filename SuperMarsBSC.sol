...
/**
   ...
   I make this #SUPERMARS to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/supermarscom
   ...
   I will renounce the ownership to burn addresses to transfer #SUPERMARS to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 90% total supply to the pool
   Can you make #SUPERMARS 1000X? 
   ...
   it's the best part of the #SUPERMARS idea, increasing the liquidity pool automatically, 
...
contract SuperMars is Context, IERC20, Ownable {
    ...
    string private _name = "Super Mars";
    string private _symbol = "SUPERMARS";
